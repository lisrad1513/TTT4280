...
#sample_period, data = raspi_import(f'ELSYSS6/Sensor/Labber/Labb2/Maalinger/MinusTilPluss/chirpNeg30', channels)
sample_period, data = raspi_import(f'ELSYSS6/Sensor/Labber/Labb2/Maalinger/MinusTilPluss/chirpPos40', channels)
...
#n_31, lag_time_s_31, r_31, lags31 = krysskorrelasjon(m3, m1, fs, True, max_lag=7)
#n_21, lag_time_s_21, r_21, lags21 = krysskorrelasjon(m2, m1, fs, True, max_lag=7)
#n_32, lag_time_s_32, r_32, lags32 = krysskorrelasjon(m3, m2, fs, True, max_lag=7)
