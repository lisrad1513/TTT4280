...
print(f"Penetrasjonsdybde for rødt lys: {delta[0] * 1e3:.2} mm")
print(f"Penetrasjonsdybde for grønt lys: {delta[1] * 1e3:.2} mm")
print(f"Penetrasjonsdybde for blått lys: {delta[2] * 1e3:.2} mm")